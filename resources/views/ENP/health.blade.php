                        ...
                        <div class="theiaStickySidebar">
                            ...
                            <div class="post clearfix">
                                ...
                                <div class="latestpost">
                                    <h2 class="title">Health Blog</h2>
                                </div>
                                
                                <div class="post-summary clearfix">
                                @foreach($healths as $health)
                                    <div class="image-thumbnail">
                                        <a href="{{ url('healthtips/'.$health->id)}}"><img alt="img-logo" src="{{ asset('images/health/' . $health->image)}}" /></a>
                                    </div>
                                    <div class="clain"><a href="{{ url('healthtips/'.$health->id)}}"><h2 class="post-title">{{ $health->title }}.</h2></a>
                                        <div class="meta">{{ date('M j, Y', strtotime($health->created_at)) }} -By the Nameof the person who spoke about it - 0 Comments</div>
                                        <div class="post-excerpt">
                                            <div class="post-excerpt-content">{!! substr(strip_tags($health->content), 0, 350) !!} {{ strlen(strip_tags($health->content)) > 350 ? "..." : ""  }}</div>
                                            <div class="read-more-link"><a href="{{ url('healthtips/'.$health->id)}}">Read More</a></div>
                                        </div>
                                    </div>
                                   @endforeach 
                                </div> 
