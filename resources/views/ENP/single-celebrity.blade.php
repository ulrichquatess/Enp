					...
					<div id="main-wrapper" class="clearfix">
						<div class="theiaStickySidebar">
							...
							<div class="post clearfix">
								...
								<!-- POST IMAGE -->
								<div id="post-header">
									<img alt="" src="{{asset('images/artist/'.$arts->image)}}" />
								</div>
								...
								<div class="meta post-meta">
									<span><i class="fa fa-clock-o"></i> {{ date('M j, Y', strtotime($arts->created_at)) }}</span> - 
									<span><i class="fa fa-comments"></i>{{ $arts->artistcomments()->count() }} Comment</span>
								</div>
								...
								<div id="comments" class="clearfix">
									<h2><i class='fa fa-comments-o'></i>{{ $arts->artistcomments()->count() }} Comment </h2>
									<div class="title-border"></div>
									
									<ol class="comments_list">
										@forelse($arts->artistcomments as $comment)
								...
								<div class="comment-form clearfix">
										...
										<div class="comments_form">
											{{ Form::open(['route' => ['artistcomments.store', $arts->id], 'method' => 'POST']) }}
