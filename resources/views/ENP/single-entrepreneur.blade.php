					...
					<div id="main-wrapper" class="clearfix">
						<div class="theiaStickySidebar">
							...
							<div class="post clearfix">
								...
								<!-- POST IMAGE -->
								<div id="post-header">
									<img alt="" src="{{asset('images/entrepreneur/'.$entrepreneur->image)}}" />
								</div>
								...
								<div class="meta post-meta">
									<span><i class="fa fa-clock-o"></i> {{ date('M j, Y', strtotime($entrepreneur->created_at)) }}</span> - 
								...
								<div id="comments" class="clearfix">
									...
									<div class="comment-form clearfix">
										...
										<div class="comments_form">
											{{ Form::open(['route' => ['comments.store', $entrepreneur->id], 'method' => 'POST']) }}
