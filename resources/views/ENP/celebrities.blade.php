                        ...
                        <div class="theiaStickySidebar">
                            ...
                            <div class="post clearfix">
                                ...
                                <div class="latestpost">
                                    <h2 class="title">Celebrity Blog</h2>
                                </div>
                                
                                <div class="post-summary clearfix">
                                @foreach($artists as $artist)
                                    <div class="image-thumbnail">
                                        <a href="{{ url('celebrities/'.$artist->id)}}"><img alt="img-logo" src="{{ asset('images/artist/' . $artist->image)}}" /></a>
                                    </div>
                                    <div class="clain"><a href="{{ url('celebrities/'.$artist->id)}}"><h2 class="post-title">{{ $artist->title }}.</h2></a>
                                        <div class="meta">{{ date('M j, Y', strtotime($artist->created_at)) }} -By the Nameof the person who spoke about it - 0 Comments</div>
                                        <div class="post-excerpt">
                                            <div class="post-excerpt-content">{!! substr(strip_tags($artist->content), 0, 350) !!} {{ strlen(strip_tags($artist->content)) > 350 ? "..." : ""  }}</div>
                                            <div class="read-more-link"><a href="{{ url('celebrities/'.$artist->id)}}">Read More</a></div>
                                        </div>
                                    </div>
                                   @endforeach 
                                </div> 
