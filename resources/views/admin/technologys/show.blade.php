      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <ul class="timeline">
            ...
            <li class="time-label">
                  <span class="bg-red">
                    {{ date( ' h:ia ', strtotime( $technology->updated_at ))}}
                  </span>
            </li>
            <!-- /.timeline-label -->
            <!-- timeline item -->
            <li>
              ...
              <div class="timeline-item">
                <span class="time"><i class="fa fa-clock-o"></i>{{ date( 'M j Y ', strtotime( $technology->updated_at ))}}</span>

                <h3 class="timeline-header"><a>{{ $technology->title  }}</a></h3>

                <div class="timeline-body">
                  {!! $technology->content !!}
                </div>
                <div class="timeline-footer">
                  <a class="btn btn-info" href="{{ route('technology.index')}}">Go Back</a>
              ...
              <div class="container" style="margin-top: 50px; margin-left: 100px;">
                <div class="row">
                  <div class="col-md-4">
                     <img src="{{asset('images/technology/'.$technology->image)}}" alt="image logo">
                  </div>
                </div>
              </div>
            </li>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  @foreach ($technology->technologycomments as $comment)
                <tr>
                  ...
                  <td>
                    <a class="btn btn-primary btn-xs" href="{{ route('technologycomments.edit', $comment->id) }}">Edit English</a>
                    {!! Form::open(['method' => 'DELETE','route' => ['technologycomments.destroy', $comment->id],'style'=>'display:inline']) !!}
